...
The code and functions used here are the ones employed to validate the model presented in [“Large-scale mapping”](../../projets.qmd) on the Work page. The method and the results are the same in R and Python — only the code (and sometimes the figure) differs; pick your language down at the code, a bit further below.
...
<a class="gofurther-tile" href="https://github.com/latsouckfaye/CompareMap" target="_blank" rel="noopener" style="--gf-accent:var(--lr-r)"><span class="gf-icon"><i class="bi bi-github"></i></span><span class="gf-label">R code on GitHub</span></a>
<a class="gofurther-tile" href="https://github.com/latsouckfaye/CompareMap/tree/main/python" target="_blank" rel="noopener" style="--gf-accent:var(--lr-py)"><span class="gf-icon"><i class="bi bi-github"></i></span><span class="gf-label">Python code on GitHub</span></a>
