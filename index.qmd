...
<p class="panelhint reveal">Conception, validation et industrialisation de modèles statistiques — la partie strictement professionnelle du site : parcours et travaux de recherche.</p>
...
<div class="showstat"><span class="shownum">3</span><span class="showsub">études de cas</span></div>
<div class="showbody">
<p class="showtitle">Travaux</p>
<span class="hubarrow">Voir <i class="bi bi-arrow-right"></i></span>
</div>
</div>
</a>
...
<div class="showstat"><span class="shownum">6 ans</span><span class="showsub">d'expérience</span></div>
<div class="showbody">
<p class="showtitle">Parcours</p>
<span class="hubarrow">Voir <i class="bi bi-arrow-right"></i></span>
</div>
</div>
</a>
</div>
<p class="panelcta reveal"><a class="hubarrow" style="--hc:var(--blue)" href="portfolio.qmd">Voir le portfolio <i class="bi bi-arrow-right"></i></a></p>
</div>
</section>

<section class="panel3">
<div class="panelinner">
<p class="panelhead reveal"><i class="bi bi-journal-code" style="color:var(--coral)" aria-hidden="true"></i><span>Tutoriels</span></p>
<p class="panelhint reveal">Des notebooks complets, en Python et en R, du prétraitement à la validation — pas seulement le résultat, toute la démarche.</p>
...
<div class="showcontent">
<div class="showimg"><img src="tutoriels/comparer-cartes/refmap.png" alt="Carte géomorphologique de référence, utilisée pour illustrer la comparaison de cartes à différentes résolutions spatiales" loading="lazy"></div>
<div class="showbody">
<p class="showtitle">Comparer des cartes</p>
...
<span class="hubarrow">Lire <i class="bi bi-arrow-right"></i></span>
</div>
</div>
</a>
<a class="showrow media reveal" href="tutoriels/echantillonnage/echantillonnage.html" style="--hc:var(--coral)">
<div class="showcontent">
<div class="showimg"><img src="tutoriels/echantillonnage/Geyser_cds.png" alt="Carte d'échantillonnage spatial par couverture, utilisée pour illustrer les méthodes d'échantillonnage stratégique" loading="lazy"></div>
<div class="showbody">
<p class="showtitle">Méthodes d'échantillonnage</p>
<div class="showtags"><span class="hubminibadge" style="color:var(--blue)">Python</span><span class="hubminibadge" style="color:var(--coral)">R</span></div>
<span class="hubarrow">Lire <i class="bi bi-arrow-right"></i></span>
</div>
</div>
...
<p class="panelcta reveal"><a class="hubarrow" style="--hc:var(--coral)" href="tutoriels.qmd">Voir les tutoriels <i class="bi bi-arrow-right"></i></a></p>
</div>
</section>
...
<p class="panelhint reveal">Ce que j'apprends et ce que je construis, aux côtés de la data : Data & Tech, Finance & Investissement, Projets & Build — les premiers articles arrivent.</p>
...
<div class="showbody">
<p class="showtitle">Finance & Investissement</p>
<span class="hubminibadge" style="color:var(--third)">Bientôt</span>
</div>
</div>
</div>
<div class="showrow teaser soon reveal" style="--hc:var(--third)">
...
<div class="showbody">
<p class="showtitle">Projets & Build</p>
<span class="hubminibadge" style="color:var(--third)">Bientôt</span>
</div>
</div>
</div>
<p class="panelcta reveal"><a class="hubarrow" style="--hc:var(--third)" href="blog.qmd">Voir le blog <i class="bi bi-arrow-right"></i></a></p>
</div>
</section>
...
startTypewriter("roleTypePortfolio", ["Data Scientist", "Ph.D.", "Enseignant", "Chercheur", "Développeur"]);
startTypewriter("roleTypeTutoriels", ["Statistique", "Apprentissage automatique", "Big Data", "IA", "Industrialisation"]);
startTypewriter("roleTypeBlog", ["Apprendre", "Expérimenter", "Construire", "Partager", "Curiosité"]);
