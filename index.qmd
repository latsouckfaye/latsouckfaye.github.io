...
<p class="panelhint reveal" data-en="Designing, validating, and industrializing statistical models — the strictly professional part of the site: career path and work.">Conception, validation et industrialisation de modèles statistiques — la partie strictement professionnelle du site : parcours et travaux.</p>
...
<div class="showimg"><img id="showimgParcours" src="images/portfolio/desk.jpg" alt="Poste de travail avec ordinateur, clavier et souris — illustration du parcours professionnel." loading="lazy"></div>
...
<div class="showcontent">
<div class="showimg"><img id="showimgTravaux" src="images/portfolio/geomorphology-map.png" alt="Carte de typologie géomorphologique d'un lagon corallien, issue d'un des travaux de cartographie." loading="lazy"></div>
...
<div class="showcase">
<a class="showrow media reveal" id="tutlinkCartes" href="tutoriels/comparer-cartes/comparer-cartes.html" style="--hc:var(--coral)">
<div class="showcontent">
...
<div class="showtags"><span class="hubminibadge" style="color:var(--third)">Python</span><span class="hubminibadge" style="color:var(--blue)">R</span></div>
<span class="hubarrow"><span data-en="Read">Lire</span> <i class="bi bi-arrow-right"></i></span>
</div>
</div>
</a>
<a class="showrow media reveal" id="tutlinkEch" href="tutoriels/echantillonnage/echantillonnage.html" style="--hc:var(--coral)">
<div class="showcontent">
...
<p class="panelhint reveal" data-en="What I'm learning and what I'm building, alongside data: Data & Tech, Finance & Investing, Projects & Creations — the first articles are coming.">Ce que j'apprends et ce que je construis, aux côtés de la data : Data & Tech, Finance & Investissement, Projets & Créations — les premiers articles arrivent.</p>
...
<div class="showbody">
<p class="showtitle" data-en="Projects & Creations">Projets & Créations</p>
<span class="hubminibadge" style="color:var(--third)" data-en="Soon">Bientôt</span>
</div>
</div>
</div>
...
var IMG_ALT_FR = {
  ...
  showimgParcours: "Poste de travail avec ordinateur, clavier et souris — illustration du parcours professionnel.",
  showimgTravaux: "Carte de typologie géomorphologique d'un lagon corallien, issue d'un des travaux de cartographie."
};
var IMG_ALT_EN = {
  ...
  showimgParcours: "Desk workspace with computer, keyboard, and mouse — illustrating professional experience.",
  showimgTravaux: "Geomorphological typology map of a coral lagoon, from one of the mapping projects."
};
var TUT_LINKS_FR = {
  tutlinkCartes: "tutoriels/comparer-cartes/comparer-cartes.html",
  tutlinkEch: "tutoriels/echantillonnage/echantillonnage.html"
};
var TUT_LINKS_EN = {
  tutlinkCartes: "tutoriels/comparer-cartes/comparer-cartes-en.html",
  tutlinkEch: "tutoriels/echantillonnage/echantillonnage-en.html"
};
function applyHomeLang(lang){
  ...
  var links = lang==="en" ? TUT_LINKS_EN : TUT_LINKS_FR;
  Object.keys(links).forEach(function(id){
    var a = document.getElementById(id);
    if(a) a.setAttribute("href", links[id]);
  });
}
